...
import org.jboss.as.quickstarts.kitchensink.service.PersonRegistration;
...
public class PersonResourceRESTService {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Person lookupMemberById(@PathParam("id") String id) {        
        System.out.println("EL ID QUE SE BUSCA ES "+id);
    ...
    public boolean emailAlreadyExists(String email) {
        ...
        System.out.println("SE VALIDA QUE EL EMAIL NO EXISTA "+email);
        ...
        System.out.println("EXISTE EL USUARIO "+emailAlreadyExist);
